...
var ICONS = {
  add: async () => (await import("./add-JT67BRYE.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-JHYKVMD7.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-QM4VTK2C.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-SNLR4QSK.js")).appStoreSvg,
  apple: async () => (await import("./apple-IVUJVPGP.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-CU3WCEGH.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-QWXWB5SE.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-ATCESCIQ.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LUKBR4Q6.js")).arrowTopSvg,
  bank: async () => (await import("./bank-TY4FMAFN.js")).bankSvg,
  browser: async () => (await import("./browser-B6MR6AV7.js")).browserSvg,
  bin: async () => (await import("./bin-RNZSBOQW.js")).binSvg,
  bitcoin: async () => (await import("./bitcoin-KHDG6QBR.js")).bitcoinSvg,
  card: async () => (await import("./card-FJFF2F2F.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-3FCVGRMM.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-LKAMXZHZ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-IPZ2DEOT.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-4BIJZK33.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-WAAB5FRC.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-SVZRDHAE.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-UCLS7RGY.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-SOKK3FTK.js")).clockSvg,
  close: async () => (await import("./close-ON6C5G3X.js")).closeSvg,
  compass: async () => (await import("./compass-V4PSEAGK.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-5DTOLEB3.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-QH4BB6KW.js")).copySvg,
  cursor: async () => (await import("./cursor-F5U4O4X7.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-FFB7DHQM.js")).cursorTransparentSvg,
  circle: async () => (await import("./circle-5WJ2A6YH.js")).circleSvg,
  desktop: async () => (await import("./desktop-6J3IAHHK.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-TJOQRO3R.js")).disconnectSvg,
  discord: async () => (await import("./discord-JGL44EOS.js")).discordSvg,
  ethereum: async () => (await import("./ethereum-MRDIKWP5.js")).ethereumSvg,
  etherscan: async () => (await import("./etherscan-MKQMQ7G7.js")).etherscanSvg,
  extension: async () => (await import("./extension-WW34VTHC.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-6WPZWYYK.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-WBXXUQ45.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-FLIICP4V.js")).farcasterSvg,
  filters: async () => (await import("./filters-MV33LCB7.js")).filtersSvg,
  github: async () => (await import("./github-GWO3BW5I.js")).githubSvg,
  google: async () => (await import("./google-C5T7EDWE.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-77AHUF6R.js")).helpCircleSvg,
  image: async () => (await import("./image-TPN6Z5AW.js")).imageSvg,
  id: async () => (await import("./id-LE57VZIJ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-CIAZ57HZ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-3LFQIV3T.js")).lightbulbSvg,
  mail: async () => (await import("./mail-V2VLFC3K.js")).mailSvg,
  mobile: async () => (await import("./mobile-AGCZSMJN.js")).mobileSvg,
  more: async () => (await import("./more-X5YAAQYY.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-TEVMXIJP.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-GJPRVAEO.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-4BQCDMF4.js")).offSvg,
  playStore: async () => (await import("./play-store-2FCRNCBS.js")).playStoreSvg,
  plus: async () => (await import("./plus-C2FPJ2CN.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-SYX5DELZ.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-OZLNWYKD.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-NZZEC45P.js")).refreshSvg,
  search: async () => (await import("./search-AEUWFKLQ.js")).searchSvg,
  send: async () => (await import("./send-6K5HJLJF.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-PCTCTJE5.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-NC7PGIYY.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-P4JGN6D3.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-LLOQBRBX.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HYF6GZVQ.js")).swapVerticalSvg,
  solana: async () => (await import("./solana-VI46NYQL.js")).solanaSvg,
  telegram: async () => (await import("./telegram-BO6YXGWV.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-IQQ54MW5.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-XG2OKWPB.js")).twitchSvg,
  twitter: async () => (await import("./x-BL743B3W.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-7XYWTKGZ.js")).twitterIconSvg,
  user: async () => (await import("./user-7YVENNVC.js")).userSvg,
  verify: async () => (await import("./verify-7VAXBDBV.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-LBTWCW5G.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-XTHR4U7H.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-P6KBYT4P.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-P6KBYT4P.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-P6KBYT4P.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-GNW6DIMY.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-ZCL7XGZN.js")).warningCircleSvg,
  x: async () => (await import("./x-BL743B3W.js")).xSvg,
  info: async () => (await import("./info-7LFOCFOJ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-OVYKDEX5.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-43L2LOQ2.js")).reownSvg,
  "x-mark": async () => (await import("./x-mark-O3BCYUFA.js")).xMarkSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LALEI7KU.js.map
